										...
										<div class="row">
											...
											<div class="span5">
												...
												<div style="float:right;">
													<a data-toggle="modal" href="#transpond_transpond{$value['source_feed']['feed_id']}">转发({$value['source_feed']['transpond_count']})</a> | 
													<a href="javascript:void(0);" data-toggle="collapse" data-target="#comment_{$value['feed_id']}_{$value['source_feed']['feed_id']}">评论({$value['source_feed']['comment_count']})</a>
												</div>
											</div>
											<!-- 评论对话框 -->
											<div class="span6">
												<div id="comment_{$value['feed_id']}_{$value['source_feed']['feed_id']}" class="collapse">暂时不能评论哦~！</div>
											</div>
										</div>
									</div>
									<div class="modal fade" id="transpond_transpond{$value['source_feed']['feed_id']}">
...
EOD;
								...
								<div class="span6">
									...
									<div style="float:right;">
										<a data-toggle="modal" href="#transpond{$value['feed_id']}">转发({$value['transpond_count']})</a> |
								...
								<!-- 转发对话框 -->
								<div class="modal fade" id="transpond{$value['feed_id']}">
									<div class="modal-header">
										<a class="close" data-dismiss="modal">×</a>
										<h3>转发微博</h3>
									</div>
